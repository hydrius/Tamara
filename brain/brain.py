...
class Brain():
    ...
    def __init__(self):
        # what does this do?
        self.tts = GoogleTTS() 
        self.modules = self.__plugins__()
        self.awake = 1
        self.__logger__("Brain online")
        self.say("Oh I'm awake")
    ...
    def __plugins__(self):
        modules = []
        locations = "/home/hydrius/projects/Tamara/Tamara/client/plugins/"
        for finder, name, ispkg in pkgutil.walk_packages(locations):
            loader = finder.find_modules(name)
            print(name)
            mod = loader.load_modules(name)
            modules.append(mod)
        return modules
